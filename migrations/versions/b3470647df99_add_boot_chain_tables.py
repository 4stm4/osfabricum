...
down_revision: Union[str, Sequence[str], None] = '77de5345d126'
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('boot_scheme_id', sa.String(36), sa.ForeignKey('boot_schemes.id'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('template_type', sa.String(64), nullable=False),  # grub_cfg, uboot_env, config_txt, etc.
        sa.Column('content', sa.Text, nullable=False),
        sa.Column('variables', sa.JSON, nullable=True),  # Available template variables
        sa.Column('metadata_json', sa.JSON, nullable=True),
    )
    op.create_index('ix_boot_chain_templates_boot_chain_id', 'boot_chain_templates', ['boot_chain_id'])
    ...
    op.create_table(
        ...
        sa.Column('template_id', sa.String(36), sa.ForeignKey('boot_chain_templates.id'), nullable=True),
    ...
    op.create_index('ix_boot_chain_bindings_boot_chain_id', 'boot_chain_bindings', ['boot_chain_id'])
